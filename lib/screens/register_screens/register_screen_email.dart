...
class RegisterScreenEmail extends StatefulWidget {
  ...
  @override
  State<RegisterScreenEmail> createState() => _RegisterScreenTwoState();
}

class _RegisterScreenTwoState extends State<RegisterScreenEmail> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          const Center(child: Text('What is your email, Angga?', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w500, color: Color(0xFF273958)))),
