              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(width: 131, height: 58, decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(40)), border: Border.all(width: 2, color: Colors.white), color: const Color(0xFF3DB2FF)), child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [const Text('Register', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400, color: Colors.white)), SvgPicture.asset('assets/CaretRight.svg')])),
